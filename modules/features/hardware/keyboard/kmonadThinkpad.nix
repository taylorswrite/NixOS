{ inputs, self, ... }:
{
  flake.nixosModules.kmonadThinkpad = { lib, config, pkgs, ... }: {
      ...
      keyboards = {
        "thinkpad-internal" = {
          ...
          config = ''
            ...
            ;; (defalias
            ;;   esc_ctl esc
            ;;   hm_a (tap-hold 120 a lalt)
            ;;   hm_s (tap-hold 120 s lsft)
            ;;   hm_d (tap-hold 120 d lmet)
            ;;   hm_f (tap-hold 120 f lctl)
            ;;   hm_j (tap-hold 120 j rctl)
            ;;   hm_k (tap-hold 120 k rmet)
            ;;   hm_l (tap-hold 120 l rsft)
            ;;   hm_sc (tap-hold 120 ; ralt)
            ;;   g_nav (tap-hold 120 g (layer-toggle nav_layer))
            ;;   h_nums (tap-hold 120 h (layer-toggle h_num_layer))
            ;; )
